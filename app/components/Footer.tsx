...
export default function Footer() {
  ...
  return (
    <div className="border-t border-t-border bg-card-solid py-8">
      <div className="wrapper max-w-[calc(100dvw-512px)]">
        <div className="px-8 flex flex-col sm:gap-y-0 gap-y-6 justify-center sm:flex-row items-center sm:justify-between">
